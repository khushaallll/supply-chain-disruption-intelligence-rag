...
TRACES_DIR = "results/traces_4"                 # the 30 real System C trace JSON files
...
OUT_PATH = "results/system_c/system_c_eval.json"        # set to None to skip writing a file and only print the report
