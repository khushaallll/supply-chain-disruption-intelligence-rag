**1. Event Summary**  
The disruption event titled *china steel* (47_china_steel_2018) occurred on **2018‑03‑01**. The investigation employed three of four planned analytical turns and was terminated early by the agent (“agent_ended_early”).

---

**2. Affected Suppliers**  

| Supplier | Tier relationship to the event | Source |
|----------|--------------------------------|--------|
| Ford Motor | Direct (tier 1) | (get_supplier_info) |
| General Motors | Direct (tier 1) | (get_supplier_info) |
| Tesla | Direct (tier 1) | (get_supplier_info) |
...
| Panasonic | Indirect (tier 2) | (get_supplier_info) |
| POSCO | Indirect (tier 2) | (get_supplier_info) |
| ZF TRW Automotive | Indirect (tier 2) | (get_supplier_info) |

---

**3. Severity (per‑dimension)**  

*Ford Motor* – proximity: **direct (tier 1)**; evidence: **single‑sourced**; freshness: **recent (21 days old)**.  
*General Motors* – proximity: **direct (tier 1)**; evidence: **single‑sourced**; freshness: **recent (23 days old)**.  
*Tesla* – proximity: **direct (tier 1)**; evidence: **single‑sourced**; freshness: **recent (6 days old)**.  
*Toyota Motor* – proximity: **direct (tier 1)**; evidence: **single‑sourced**; freshness: **recent (251 days old)**.  
*BP* – proximity: **indirect (tier 2)**; evidence: **single‑sourced**; freshness: **recent (329 days old)**.  
*Exxon Mobil* – proximity: **indirect (tier 2)**; evidence: **single‑sourced**; freshness: **recent (1 day old)**.  
*Panasonic* – proximity: **indirect (tier 2)**; evidence: **single‑sourced**; freshness: **stale (2072 days old, exceeds the 730‑day threshold)**.  
*POSCO* – proximity: **indirect (tier 2)**; evidence: **single‑sourced**; freshness: **recent (308 days old)**.  
*ZF TRW Automotive* – proximity: **indirect (tier 2)**; evidence: **single‑sourced**; freshness: **stale (1112 days old, exceeds the 730‑day threshold)**.
...
- ZF TRW Automotive: **only stale evidence (1112 days old)**  
...
- Panasonic: **only stale evidence (2072 days old)**  
...
- Chang’an Ford Automobile: **no evidence gathered**  
...
- AAPICO HiTech PCL: **no evidence gathered**  
